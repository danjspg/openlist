-- Dedicated category pages read exact classifier-owned category membership.
-- The existing partial GIN index on planning_seo_notable.notable_categories
-- supports this containment predicate; no table rewrite or index build occurs.
