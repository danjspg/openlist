create or replace function public.openlist_planning_status_refresh_buckets(p_bucket_limit integer default 12)
returns table(local_authority_code text, period_start date, period_end date, candidate_count bigint, least_recently_checked_at timestamptz)
language sql
stable
security definer
