...
/** @param {any} supabase @param {Record<string, any>[]} records @param {{ authorityCode: string, from?: string, to?: string, pageSize?: number, preserveUnobservedFields?: string[], preserveWeakerFields?: string[] }} options */
