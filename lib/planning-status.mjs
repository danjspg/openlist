...
const ACTIVE_PLANNING_STATUSES = Object.freeze([
  "pre_validation",
  "registered",
  "under_assessment",
  "further_information_requested",
...
const ACTIVE_PLANNING_STATUS_SET = new Set(ACTIVE_PLANNING_STATUSES)
...
const PLANNING_STATUS_OPTIONS = Object.keys(STATUS_LABELS).map((value) => ({
  value,
  label: planningStatusLabel(value),
}))
...
function isActivePlanningStatus(value) {
  return ACTIVE_PLANNING_STATUS_SET.has(value)
}
