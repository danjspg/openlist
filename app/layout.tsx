  ...
  return <html lang="en" className="overflow-x-hidden"><body className="overflow-x-hidden bg-stone-50 text-stone-900"><AuthStateProvider>
    ...
    <footer className="mt-16 border-t border-stone-200 bg-white"><div className="mx-auto max-w-6xl px-4 py-10 sm:px-6"><div className="grid gap-10 lg:grid-cols-[1.05fr_1.65fr] lg:gap-14"><div><Link href="/" aria-label="OpenList homepage" className="inline-flex"><Image src="/logo-v2.png" alt="OpenList" width={450} height={131} className="h-auto w-40" /></Link><p className="mt-4 max-w-md text-sm leading-6 text-stone-600">Irish planning applications and sold-price data, organised to make local research faster and easier to understand.</p><p className="mt-4 max-w-md text-xs leading-5 text-stone-400">Public-data research only. Always check the relevant official source before relying on a record.</p></div>
      <nav aria-label="Footer" className="grid grid-cols-2 gap-x-7 gap-y-9 text-sm text-stone-600 sm:grid-cols-4">
        <FooterLinkGroup title="Planning"><Link href="/planning" className="transition hover:text-stone-900">Planning overview</Link><Link href="/planning/areas" className="transition hover:text-stone-900">Cities, towns & areas</Link><Link href="/planning#planning-by-authority" className="transition hover:text-stone-900">Local authorities</Link><Link href="/planning/categories" className="transition hover:text-stone-900">Notable developments</Link></FooterLinkGroup>
        <FooterLinkGroup title="Activity"><Link href="/planning?construction=commenced" className="transition hover:text-stone-900">Construction started</Link><Link href="/planning?status=decision_made" className="transition hover:text-stone-900">Recent decisions</Link><Link href="/planning?status=further_information" className="transition hover:text-stone-900">Further information</Link><Link href="/search" className="transition hover:text-stone-900">Unified search</Link></FooterLinkGroup>
        <FooterLinkGroup title="Property"><Link href="/sold-prices/search" className="transition hover:text-stone-900">Search sold prices</Link><Link href="/sold-prices" className="transition hover:text-stone-900">Market overview</Link><Link href="/sold-prices/counties-compared" className="transition hover:text-stone-900">Compare counties</Link><AccountFooterLink /></FooterLinkGroup>
